    ...
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-sm-12">
                <div class="card medical-card">
                    <div class="card-body p-0">
                      <form class="row" action="{{route('user.userUpdate1')}}" method="post">
                        @csrf

                        <input type="hidden" name="hidden" value="{{$data->id}}">
                        <div class="mb-3 col-md-6">
                            <label for="exampleFormControlInput1" class="form-label">لقب</label>
                            <input type="text" class="form-control" id="exampleFormControlInput1" value="{{$data->name}}" name="name" placeholder="">
                        </div>
                        <div class="mb-3 col-md-6">
                            <label for="exampleFormControlInput1" class="form-label">البريد الإلكتروني</label>
                            <input type="email" class="form-control" id="exampleFormControlInput1" value="{{$data->email}}" name="email" placeholder="">
                        </div>
                     <!--    <div class="mb-3 col-md-6">
