                                        ...
                                        <div class="form form-clean">
                                            ...
                                            <div class="row circle-bottom justify-content-center">
                                                ...
                                                <div class="col-md-6 col-lg-4 mt-5 ad">
                                                    ...
                                                    <select class="form-select gender" required name="print"
                                                        aria-label="Default select example">
                                                        <option></option>
                                                        <option value="الاشكال هنا  ">الاشكال هنا</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-6 col-lg-4 mt-5 ad">
                                                    <label class="form-label dot">تقنية الطباعة</label>
                                                    <select class="form-select gender" required name="format"
                                                        aria-label="Default select example">
                                                        <option></option>
                                                        <option value="35">+ 35 ريال التقنية الأولي</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-action requests">
                                                            <input type="submit" class="btn-form designer-btn clean-btn"
                                                                value="
                                                                تقديم طلب  ">
                                                        ...
                                                        <div class="design-card-inner">
                                                            ...
                                                            <a href="javascript:void(0);" class=""
                                                               ...
                                                               <div class="design-card-body">
                                                                <img src="{{$product->images ? asset('storage/'.$product->images[0]) : ' '}}"
                                                    ...
                                                    <div class="col-md-6 col-lg-4" id="{{$product_d->id}}">
                                                        <div class="design-card-inner">
                                                            ...
                                                            <a href="javascript:void(0);" class=""
                                                               ...
                                                               <div class="design-card-body">
                                                                <img src="{{$product_d->images ? asset('storage/'.$product_d->images[0]) : ' '}}"
                                                                    class="design-img img-fluid" alt="">
                                                                <div class="design-card-left-top">
  ...
  opacity: 0;">
                                        ...
                                        <div class="form-inner-wrapper wrapper jst-btw">
                                            <div class="almuntjat-form__box ">
                                                ...
                                                <div class="input-holder">
                                                    <select class="form-select gender" required name="print_technology"
                                                        aria-label="Default select example">
                                                        <option></option>
                                            ...
                                            <div class="almuntjat-form__box">
                                                ...
                                                <div class="input-holder">
                                                    <select class="form-select" required name="software"
                                                        aria-label="Default select example">
                                                        <option></option>
                                                        <option>اختاير البرامج المستخدمة</option>
                                                    </select>
                                        ...
                                        <input type="submit" class="almuntjat-form__btn m-btn" value="submit" >
                                        <p class="almuntjat-form__text">
                                            تعديل بيانات المنتج
                                        </p>
                                    </form>
...
processData: false,
               success:function(data) {
                ...
                $('#subImages').append(`<div class="col-auto p-0 card-img-main"><img src="{{asset(Storage::url('/'))}}/${value}"                                                            alt=""></div>`
                    );
                });
         ...
         $('#designer_request ').on('click',function(){
