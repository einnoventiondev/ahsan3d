                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="modal-body">
                            <div class="container">
                                <div class="row">
                                    @if(@$links->youtubeurld2 != null)
                                    <div class="col-md-12 text-center">
                                        <iframe width="560" height="315" src="{{$links->youtubeurld2}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
                                    @else
                                    <div class="col-md-12 text-center">
