                                            ...
                                            <div class="col-md-12">
                                                <div class="row justify-content-center">
                                                    <div class="col-md-12">
                                                        ...
                                                        @if(count($perposal))
                                                            <div class="wrapper jst-center userReq-btn-box public-order-buttons">
                                                                <button
                                                                    class="userReq-btn-box__btn userReq-btn-box__btn--a credit-btn-blur-show">قبول</button>

                                                                    <!-- <button
                                                                    class="userReq-btn-box__btn userReq-btn-box__btn--a "
                                                                    data-bs-toggle="modal"
                                                                    {{-- user2RequestModal --}}
                                                                    data-bs-target="#publicPaymentModal">قبول</button> -->

                                                                <button class="userReq-btn-box__btn userReq-btn-box__btn--b toggle_button" id="{{@$public->id}}"
                                                                    data-bs-toggle="modal"
                                                                ...
                                                                <a href="https://hopeful-montalcini.161-97-115-110.plesk.page/3d_organsm/public/perposal/pdf/43"
                                                                    class="userReq-btn-box__btn payment-click-btn userReq-btn-box__btn--c mgl-0">عرض
                                                                    السعر</a>

                                                                {{-- <a href="{{route('payment')}}" class="btn btn-form mx-3 with-arrow mt-10">عرض السعر</a> --}}
                                                            </div>

                                                            <div class="public-order-cross-btn d-none">
                                                            <div class="form-action">
                                                        <button class="btn btn-form mx-3 show-order-agaim  disabled toggle_button1" id="{{@$public->id}}">التالي</button>
                                                    </div>
