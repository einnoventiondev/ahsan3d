                                                ...
                                                <div class="col-md-12 col-xl-9 col-xxl-9">
                                                    <div class="row mb-2">
                                                        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4 mt-4">
                                                            ...
                                                            <input type="text" class="form-control name" placeholder=".. الاسم هنا" name="name" value="">
                                                        </div>
                                                        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4 mt-4">
                                                            <label class="form-label dot">رقم الهاتف</label>
                                                            <input type="number" pattern="\d*" class="form-control phone" placeholder=".. التخصص هنا" name="phone" value="">
                                                        </div>
                                                        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4 mt-4">
                                                ...
                                                <div class="col-md-12 col-xl-9 col-xxl-9">
                                                    ...
                                                    <div class="row mb-2">
                                                        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4 mt-4">
                                                            ...
                                                            <input type="text" class="form-control type" placeholder=".. الاسم هنا" value="" name="pr_type">
                                                        </div>
                                                        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4 mt-4">
                                                            <label class="form-label dot">لون الطباعة</label>
                                                            <input type="text" class="form-control spec" placeholder=".. التخصص هنا" value="" name="pr_clr">
                                                        </div>
                                                        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4 mt-4">
                                                            <label class="form-label dot">دقة الطباعة (صورة
                                                                كمثال)</label>
                                                            <input type="text" class="form-control print-resolution" placeholder=".. الايميل هنا" value="" name="pr_res">
                                                        </div>
                                                    ...
                                                    <div class="form-action">
                                                        <button class="btn invert btn-form mx-3 with-arrow disabled" data-bs-target="#carouselIndicators" data-bs-slide="next"><img src="{{asset('user/assets/icons/arrow-right.svg')}}" alt="arrow-right"> التالي</button>
                                                        <p>تفاصيل الطباعة</p>
                                                    </div>
