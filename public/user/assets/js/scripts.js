$(function() {
    ...
    $('.payment .form-check-label').click(function() {
        ...
        $('.show-order-agaim').removeClass('disabled');
    })
...
$(document).ready(function() {
    ...
    // color active choose color

    $(".color-circle-main .color-circle").click(function() {
        $(this).prevAll().removeClass('active');
        $(this).nextAll().removeClass('active');
        $(this).addClass('active');
    ...
    $('#view-order .credit-btn-blur-show').click(function() {
        $('#view-order').find('.conditional-blur').addClass('blur');
        $('#view-order').find('.payment.credit-payment').removeClass('d-none');
        $('#view-order').find('.success-btn-userReq').removeClass('d-none');
        $('#view-order').find('.userReq-buttons-hide').addClass('d-none');

    })
    $('#view-order .show-order-agaim').click(function() {
        $('#view-order').find('.conditional-blur').removeClass('blur');
        $('#view-order').find('.payment.credit-payment').addClass('d-none');
        $('#view-order').find('.success-btn-userReq').addClass('d-none');
        $('#view-order').find('.userReq-buttons-hide').removeClass('d-none');

    })

    $('#public-order .credit-btn-blur-show').click(function() {
        $('#public-order').find('.conditional-blur').addClass('blur');
        $('#public-order').find('.payment.credit-payment').removeClass('d-none');
        $('#public-order').find('.public-order-buttons').addClass('d-none');
        $('#public-order').find('.public-order-cross-btn').removeClass('d-none');
    })
    $('#public-order .show-order-agaim').click(function() {
        $('#public-order').find('.conditional-blur').removeClass('blur');
        $('#public-order').find('.payment.credit-payment').addClass('d-none');
        $('#public-order').find('.public-order-buttons').removeClass('d-none');
        $('#public-order').find('.public-order-cross-btn').addClass('d-none');
    })
