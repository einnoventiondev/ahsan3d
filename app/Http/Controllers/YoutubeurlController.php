...
class YoutubeurlController extends Controller
{
    ...
    {    $youtubeurls = Youtubeurl::all();
        ...
        return view('pages.admin.dashboard.youtubeurl.create',compact('youtubeurls'));
    }
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'youtubeurld1' => 'required',
            'youtubeurld2' => 'required',
        ...
        Youtubeurl::create([
            ...
            'youtubeurld1' => $request->youtubeurld1,
            'youtubeurld2' => $request->youtubeurld2,
        ]);
